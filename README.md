...
- <img src="https://qdrant.tech/img/brand-resources-logos/logomark.svg" height="14"/> [workspace-qdrant-mcp](https://github.com/ChrisGVE/workspace-qdrant-mcp) - Project-scoped semantic workspace memory for AI coding assistants. Watches project files, auto-indexes code and docs into Qdrant with tree-sitter semantic chunking and hybrid search (dense + sparse + RRF fusion). 6 MCP tools. **Alpha** — testers and feedback welcome.
